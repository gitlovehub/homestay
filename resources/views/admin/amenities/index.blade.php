    ...
    <div class="mx-auto max-w-screen-2xl">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div class="flex items-center justify-between gap-4">
                <form method="GET">
                    <input type="search" name="search" value="{{ request('search') }}" placeholder="Tìm kiếm tiện ích..."
        ...
        <section class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div
                ...
                <div class="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-rose-50 text-rose-600">
                    ...
                    <svg class="h-7 w-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="9" stroke="red" stroke-width="2" fill="none" />
                        <path stroke="red" stroke-linecap="round" stroke-width="2" d="M7.05 7.05l9.9 9.9" />
                    </svg>
        ...
        <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div class="border-b border-slate-200 bg-slate-50/70 p-5">
                ...
                <form method="GET" action="{{ route('admin.amenities.index') }}" class="grid gap-4 lg:grid-cols-12">
                    ...
                    <div class="lg:col-span-7">
                        ...
                        <div class="relative">
                            ...
                            <input id="search" name="search" type="search" value="{{ request('search') }}" class="h-12"
                                placeholder="Tên tiện ích, slug hoặc mô tả..."
                                class="h-12 w-full rounded-xl border border-slate-300 bg-white py-3 pl-11 pr-4 text-sm text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-4 focus:ring-blue-100"
                    ...
                    <div class="flex items-end lg:col-span-1">
                        ...
                        @if (request()->hasAny(['search', 'status']))
                            <a href="{{ route('admin.amenities.index') }}" title="Xóa bộ lọc"
                                ...
                                <tr class="transition hover:bg-slate-50/80">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-5">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div
                                                class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-blue-100 bg-blue-50 text-xl text-blue-600">
                                                {{ $amenity->icon ?: '✨' }}
                                            </div>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-5 text-center">
                                        ...
                                        <span
                                            class="inline-flex min-w-10 items-center justify-center rounded-full border border-violet-100 bg-violet-100 px-3 py-1.5 text-xs font-semibold text-violet-700">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-5">
                                        ...
                                        @else
                                            <span
                                                class="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-100 px-4 py-1.5 text-xs font-semibold text-slate-600">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-5 text-right">
                                        ...
                                        <details data-action-menu class="relative inline-block text-left">
                                            ...
                                            <div
                                                class="absolute right-0 z-40 mt-2 w-35 overflow-hidden rounded-xl border border-slate-200 bg-white text-left shadow-xl">

                                                {{-- Xem --}}
                                                <a href="{{ route('admin.amenities.show', $amenity) }}"
                                                    class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-blue-700 transition hover:bg-blue-50">
                                                ...
                                                <a href="{{ route('admin.amenities.edit', $amenity) }}"
                                                    class="flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-amber-500 transition hover:bg-amber-50">
                                                    <svg viewBox="0 0 24 24" class="h-4 w-4" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round">
                                                        <path
                                                ...
                                                <form method="POST"
                                                    ...
                                                    <button type="submit"
                                                        ...
                                                        class="flex w-full cursor-pointer items-center gap-3 px-4 py-2.5 text-left text-sm font-medium text-red-600 transition hover:bg-red-50">
                                                        <svg viewBox="0 0 24 24" class="h-4 w-4" fill="none"
                                                            stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                                            stroke-linejoin="round">
