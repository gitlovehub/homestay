    ...
    <main class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        >
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            {{ in_array(
                                                ...
                                                old(
                                                    'amenities',
                                                    $homestay->amenities->pluck('id')->toArray()
                                                )
                                            ) ? 'checked' : '' }}
                                        >
                        ...
                        >
                            <div class="flex items-start gap-3">
                                <input
                                    ...
                                    @checked(old('status', $homestay->status) == 1)
                                >
                        ...
                        >
                            <div class="flex items-start gap-3">
                                <input
                                    ...
                                    @checked(old('status', $homestay->status) == 0)
                                >
            ...
            <div class="flex flex-col-reverse gap-3 border-t border-slate-200 bg-slate-50 px-6 py-5 sm:flex-row sm:justify-end sm:px-8">
                ...
                <button
                    type="submit"
                    class="cursor-pointer inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-blue-700"
                >
                    Cập nhật Homestay
                </button>
