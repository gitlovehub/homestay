    ...
    <div class="mx-auto max-w-screen-2xl">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <p class="text-sm font-semibold md:text-lg text-slate-500">
                Chi tiết thông tin khách hàng, Homestay và nội dung đánh giá.
            </p>
            ...
            <div class="min-w-0 space-y-6 lg:col-span-2">
                ...
                <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-200 bg-slate-50/80 px-5 py-4 sm:px-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-base font-bold text-slate-900 sm:text-lg">Nội dung đánh giá</h2>
                                <p class="mt-0.5 text-sm text-slate-500">Nhận xét của khách hàng sau thời gian lưu trú</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-5 sm:p-6">
                        {{-- Rating --}}
                        <div
                            class="rounded-2xl border border-amber-100 bg-gradient-to-br from-amber-50 to-orange-50/50 p-5">
                            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                <div class="flex items-center gap-1" aria-label="{{ $review->rating }} trên 5 sao">
                                    @for ($star = 1; $star <= 5; $star++)
                                        <span
                                            class="text-3xl leading-none {{ $star <= $review->rating ? 'text-amber-400' : 'text-slate-200' }}">
                                            ★
                                        </span>
                                    @endfor
                                </div>
                                <p class="text-2xl font-bold text-slate-900">
                                    ...
                                    <span class="text-base font-medium text-slate-500">/ 5</span>
                                </p>
                            </div>
                        </div>
                        ...
                        {{-- Tiêu đề --}}
                        <div class="mt-6">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-400">Tiêu đề</p>
                        ...
                        {{-- Nội dung --}}
                        <div class="mt-5">
                            <p class="text-xs font-semibold uppercase tracking-wider text-slate-400">Nội dung</p>
                        ...
                        <div class="mt-5 flex flex-wrap items-center gap-3 text-sm">
                            <span
                                class="inline-flex items-center rounded-lg bg-blue-50 px-3 py-1.5 font-medium text-blue-600">
                ...
                <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-200 bg-slate-50/80 px-5 py-4 sm:px-6">
                        <div class="flex items-center gap-3">
                            <span
                                class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-100 text-xl">
                                👤
                            </span>
                            <div>
                                <h2 class="text-base font-bold text-slate-900 sm:text-lg">Thông tin khách hàng</h2>
                                <p class="mt-0.5 text-sm text-slate-500">Người đã gửi đánh giá này</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-5 sm:p-6">
                        <div class="mb-6 flex items-center gap-4">
                            <div
                                class="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-blue-100 text-lg font-bold text-blue-700 sm:h-16 sm:w-16 sm:text-xl">
                                {{ $avatarText ?: '?' }}
                            </div>
                            <div class="min-w-0">
                                <p class="truncate text-lg font-bold text-slate-900">{{ $userName }}</p>
                        ...
                        <dl class="grid gap-4 sm:grid-cols-2">
                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Họ và tên</dt>
                                <dd class="mt-1.5 font-semibold text-slate-900 break-words">{{ $userName }}</dd>
                            </div>

                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Email</dt>
                                <dd class="mt-1.5 font-semibold text-slate-900 truncate"
                            ...
                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Mã đơn đặt phòng
                                </dt>
                ...
                <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-200 bg-slate-50/80 px-5 py-4 sm:px-6">
                        <div class="flex items-center gap-3">
                            <span
                                class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-emerald-100 text-xl">
                                🏡
                            </span>
                            <div>
                                <h2 class="text-base font-bold text-slate-900 sm:text-lg">Thông tin Homestay</h2>
                                <p class="mt-0.5 text-sm text-slate-500">Nơi lưu trú được khách hàng đánh giá</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-5 sm:p-6">
                        <dl class="grid gap-4 sm:grid-cols-2">
                            <div class="rounded-xl bg-slate-50 p-4 sm:col-span-2">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Tên Homestay</dt>
                            ...
                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Phòng</dt>
                                <dd class="mt-1.5 font-semibold text-slate-900">
                            ...
                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Loại phòng</dt>
                                <dd class="mt-1.5 font-semibold text-slate-900">
                            ...
                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Ngày nhận phòng
                                </dt>
                                <dd class="mt-1.5 font-semibold text-slate-900">
                            ...
                            <div class="rounded-xl bg-slate-50 p-4">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Ngày trả phòng
                                </dt>
                                <dd class="mt-1.5 font-semibold text-slate-900">
                            ...
                            <div class="rounded-xl bg-slate-50 p-4 sm:col-span-2">
                                <dt class="text-xs font-semibold uppercase tracking-wider text-slate-400">Địa chỉ</dt>
            ...
            <aside class="min-w-0 space-y-6">
                ...
                <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-200 bg-slate-50/80 px-5 py-4 sm:px-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-base font-bold text-slate-900 sm:text-lg">Thao tác nhanh</h2>
                                <p class="mt-0.5 text-sm text-slate-500">Kiểm duyệt đánh giá</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 p-5 sm:p-6">
                        @if ($review->status === 'pending')
                            ...
                            <form method="POST" action="{{ route('admin.reviews.update-status', $review) }}">
                                ...
                                <button type="submit"
                                    ...
                                    class="inline-flex cursor-pointer w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-700 focus:outline-none focus:ring-4 focus:ring-emerald-100">
                            ...
                            <form method="POST" action="{{ route('admin.reviews.update-status', $review) }}">
                                ...
                                <button type="submit" onclick="return confirm('Bạn có chắc muốn ẩn đánh giá này không?')"
                                    class="inline-flex cursor-pointer w-full items-center justify-center gap-2 rounded-xl border border-red-200 bg-red-50 px-5 py-3 text-sm font-semibold text-red-600 transition hover:border-red-300 hover:bg-red-100 hover:text-red-700 focus:outline-none focus:ring-4 focus:ring-red-100">
                        ...
                        @elseif ($review->status === 'approved')
                            <div
                                class="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm leading-6 text-emerald-700">
                ...
                <section class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                    <div class="border-b border-slate-200 bg-slate-50/80 px-5 py-4 sm:px-6">
                        <div class="flex items-center gap-3">
                            <span
                                class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-indigo-100 text-xl">
                                📋
                            </span>
                            <h2 class="text-base font-bold text-slate-900 sm:text-lg">Thông tin hệ thống</h2>
                        </div>
                    </div>
