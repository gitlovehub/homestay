                ...
                <section>
                    ...
                    <div class="grid gap-6 overflow-visible md:grid-cols-2">
                        ...
                        <div x-data="{
                            ...
                            get selectedName() {
                                const homestay = this.homestays.find(item => String(item.id) === String(this.selected));
                            ...
                            <button type="button"
                                    @click="open = !open"
                                    :class="{
                                        'border-red-400 focus:border-red-500 ring-4 ring-red-100': {{ $errors->has('homestay_id') ? 'true' : 'false' }},
                                ...
                                <template x-for="homestay in homestays" :key="homestay.id">
                                    <button type="button"
                                        ...
                                        <svg x-show="selected === String(homestay.id)"
                                            class="ml-3 h-5 w-5 shrink-0 text-blue-600"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <label class="cursor-pointer">
                            <input type="radio"
                                ...
                                value="maintenance"
                                class="peer sr-only"
                                @checked(old('status') === 'maintenance')>
