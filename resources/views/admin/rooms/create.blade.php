                ...
                <section>
                    ...
                    <div class="grid gap-6 overflow-visible md:grid-cols-2">
                        ...
                        <div x-data="{
                            ...
                            <label for="homestay_id" class="mb-2 block text-sm font-semibold text-slate-700 dark:text-slate-300">
                                Homestay
                            ...
                            <button type="button"
                                    @click="open = !open"
                                    :class="{
                                        'border-red-400 focus:border-red-500 ring-4 ring-red-100 dark:border-red-500 dark:focus:border-red-400 dark:ring-red-900/30': {{ $errors->has('homestay_id') ? 'true' : 'false' }},
                            ...
                            <div x-cloak
                                ...
                                <template x-for="homestay in homestays" :key="homestay.id">
                                    <button type="button"
                                            ...
                                            class="flex h-11 w-full items-center justify-between rounded-lg px-3 text-left text-sm font-medium transition">
