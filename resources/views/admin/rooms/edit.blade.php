...
@section('content')
    <div class="mx-auto max-w-4xl">
        ...
        <p class="mb-4 text-sm font-semibold md:text-lg text-slate-500">
            Chỉnh sửa thông tin phòng <span class="font-bold text-blue-700">{{ $room->name }}</span>.
        </p>
            ...
            <div class="space-y-8 p-6 sm:p-8">
                ...
                <section>
                    <div class="mb-6">
                        ...
                        <p class="mt-1 text-sm text-slate-500">Thông tin nhận diện và phân loại phòng.</p>
                    </div>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div x-data="{
                            ...
                            <label for="homestay_selector" class="mb-2 block text-sm font-semibold text-slate-700">
                                Homestay
                            ...
                            <button id="homestay_selector"
                                    ...
                                    :aria-expanded="open"
                                    :class="{
                                        'border-red-400 ring-4 ring-red-100': {{ $errors->has('homestay_id') ? 'true' : 'false' }},
                                        'border-blue-500 ring-4 ring-blue-100': open && !{{ $errors->has('homestay_id') ? 'true' : 'false' }},
                                        'border-slate-300 hover:border-slate-400': !open && !{{ $errors->has('homestay_id') ? 'true' : 'false' }}
                                    }"
                                    class="flex h-11 w-full items-center justify-between rounded-xl border bg-white px-4 text-left text-slate-900 outline-none transition">
                                <span x-show="selectedName" x-text="selectedName" class="truncate font-medium"></span>
                                <span x-show="!selectedName" class="text-slate-400">-- Chọn Homestay --</span>
                            ...
                            <div x-cloak
                                ...
                                <template x-for="homestay in homestays" :key="homestay.id">
                                    <button type="button"
                                            ...
                                            :class="selected === String(homestay.id) ? 'bg-blue-50 text-blue-700' : 'text-slate-700 hover:bg-slate-100'"
                ...
                <section>
                    <div class="mb-6">
                        <h2 class="text-lg font-bold text-slate-900">Giá và thông số phòng</h2>
                        <p class="mt-1 text-sm text-slate-500">Thiết lập giá mỗi đêm, sức chứa và diện tích phòng.</p>
                    </div>
                    ...
                    <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative">
                                <input id="price_per_night"
                                    ...
                                    min="0"
                                    placeholder="500000"
                                    class="h-11 w-full rounded-xl border px-4 pr-16 text-slate-900 outline-none transition placeholder:text-slate-400
                        ...
                        <div>
                            ...
                            <input id="capacity"
                                ...
                                min="1"
                                class="h-11 w-full rounded-xl border px-4 text-slate-900 outline-none transition
                                    {{ $errors->has('capacity')
                                        ? 'border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-100'
                                        : 'border-slate-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-100' }}">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div class="relative">
                                <input id="area"
                                    ...
                                    step="1"
                                    placeholder="25"
                                    class="h-11 w-full rounded-xl border px-4 pr-14 text-slate-900 outline-none transition placeholder:text-slate-400
                                        {{ $errors->has('area')
                                            ? 'border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-100'
                                            : 'border-slate-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-100' }}">
                ...
                <section>
                    <div class="mb-6">
                        <h2 class="text-lg font-bold text-slate-900">Hình ảnh phòng</h2>
                        <p class="mt-1 text-sm text-slate-500">Chọn một ảnh đại diện rõ ràng cho phòng.</p>
                    </div>
                ...
                <section>
                    <div class="mb-6">
                        <h2 class="text-lg font-bold text-slate-900">Mô tả phòng</h2>
                    </div>
                        ...
                        <textarea id="description"
                                ...
                                class="w-full resize-y rounded-xl border px-4 py-3 text-slate-900 outline-none transition placeholder:text-slate-400
                                    {{ $errors->has('description')
                                        ? 'border-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-100'
                                        : 'border-slate-300 focus:border-blue-500 focus:ring-4 focus:ring-blue-100' }}">{{ old('description', $room->description) }}</textarea>
                ...
                <section>
                    <div class="mb-6">
                        <h2 class="text-lg font-bold text-slate-900">Trạng thái phòng</h2>
                        <p class="mt-1 text-sm text-slate-500">Chọn trạng thái hoạt động hiện tại của phòng.</p>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <label class="cursor-pointer">
                            ...
                            <div class="flex items-start gap-4 rounded-2xl border-2 border-slate-200 p-5 transition
                                ...
                                <p class="font-bold text-slate-900">Còn trống</p>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer">
                            ...
                            <div class="flex items-start gap-4 rounded-2xl border-2 border-slate-200 p-5 transition
                                ...
                                <p class="font-bold text-slate-900">Bảo trì</p>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer">
                            ...
                            <div class="flex items-start gap-4 rounded-2xl border-2 border-slate-200 p-5 transition
                                ...
                                <p class="font-bold text-slate-900">Ngừng hoạt động</p>
                            </div>
                        </label>
