                    ...
                    <div class="flex items-end sm:col-span-1 lg:col-span-1">
                        @if (request()->hasAny(['search', 'status', 'sort']))
                            <a href="{{ route('admin.rooms.index') }}"
                                title="Xóa bộ lọc"
                                class="inline-flex h-11 w-full items-center justify-center rounded-xl bg-blue-600 px-4 text-xs font-semibold text-white shadow-sm transition hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900/40 sm:text-sm">
                        ...
                        @else
                            <button type="button"
                                ...
                                class="inline-flex h-11 w-full cursor-not-allowed items-center justify-center rounded-xl border border-slate-200 bg-slate-100 px-4 text-xs font-semibold text-slate-400 dark:border-slate-700 dark:bg-slate-700 dark:text-slate-500 sm:text-sm">
