...
@section('content')
    ...
    <div class="mx-auto max-w-screen-2xl">
        ...
        <h2 class="mb-8 text-lg font-semibold text-slate-900 dark:text-slate-100 md:text-2xl">
            Theo dõi thông tin, hoạt động đặt phòng và quản lý trạng thái tài khoản trong hệ thống.
        </h2>
                                        ...
                                        <div
                                            x-data="{
                                                ...
                                                toggle() {
                                                    ...
                                                    // Canh phải dropdown với nút 3 chấm
                                                ...
                                                >
                                                    ...
                                                    @if (!$isCurrentUser)
                                                        ...
                                                        <form
                                                            ...
                                                            onsubmit="return confirm('{{ $user->status === 'active'
                                                            ...
                                                            <button
                                                                ...
                                                                class="group flex w-full cursor-pointer items-center gap-3
                                                                    ...
                                                                    {{ $user->status === 'active'
                                                                        ...
                                                                        : 'text-emerald-600 hover:bg-emerald-50 focus:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-950/50 dark:focus:bg-emerald-950/50' }}"
                                                            >
                                                                <span
                                                                    class="flex h-8 w-8 shrink-0 items-center justify-center
                                                                        ...
                                                                        {{ $user->status === 'active'
                                                                            ? 'bg-red-50 text-red-500 group-hover:bg-red-100 dark:bg-red-950/60 dark:text-red-400 dark:group-hover:bg-red-950/80'
                                                                            : 'bg-emerald-50 text-emerald-500 group-hover:bg-emerald-100 dark:bg-emerald-950/60 dark:text-emerald-400 dark:group-hover:bg-emerald-950/80' }}"
                                                                >
