        ...
        <div class="hidden lg:block">
            ...
            <div class="mt-10 space-y-5">
                <div class="flex items-start gap-4">
                    <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-blue-100 text-xl">🏠</span>
                    <div>
                ...
                <div class="flex items-start gap-4">
                    <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-emerald-100 text-xl">✓</span>
                    <div>
                ...
                <div class="flex items-start gap-4">
                    <span class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-amber-100 text-xl">🔒</span>
                    <div>
        ...
        <div class="mx-auto w-full max-w-lg">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/10 sm:p-9">
                <div class="text-center">
                    ...
                    <h2 class="mt-7 text-3xl font-bold tracking-tight text-slate-950">Đăng nhập</h2>
                    <p class="mt-2 text-sm text-slate-500">Nhập thông tin tài khoản để tiếp tục.</p>
                </div>
