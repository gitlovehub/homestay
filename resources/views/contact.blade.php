...
@section('content')
    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        <div class="pointer-events-none absolute -right-24 -top-24 h-72 w-72 rounded-full bg-blue-200/40 blur-3xl sm:h-80 sm:w-80"></div>
        <div class="pointer-events-none absolute -left-20 bottom-0 h-56 w-56 rounded-full bg-indigo-200/30 blur-3xl"></div>

        <div class="relative mx-auto max-w-7xl px-4 py-14 text-center sm:px-6 sm:py-16 lg:px-8 lg:py-20">
            <p class="text-sm font-semibold uppercase tracking-widest text-blue-600">
                HomeStayGo
            </p>
            <h1 class="mt-3 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                Liên hệ với chúng tôi
            </h1>
            <p class="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:mt-5 sm:text-lg sm:leading-8">
            ...
            <div class="grid gap-8 lg:grid-cols-5 lg:gap-10">
                ...
                <div class="order-2 lg:order-1 flex flex-col gap-6 lg:col-span-2">
                    ...
                    <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
                        ...
                        <div class="h-[280px] w-full sm:h-[320px] lg:h-[350px]">
                            <iframe
                        ...
                        <div class="p-5 sm:p-6">
                            <a
                                ...
                                class="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-5 py-3.5 text-sm font-bold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-200"
                            >
                    ...
                    {{-- Thẻ liên hệ --}}
                    <div class="rounded-3xl bg-slate-950 p-6 text-white shadow-xl sm:p-7">
                        ...
                        <div class="mt-6 space-y-5">
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="pt-0.5">
                                    <p class="text-xs text-slate-400">Địa chỉ</p>
                ...
                <div class="order-1 lg:order-2 lg:col-span-3">
                    <div class="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl shadow-slate-900/5 sm:p-6 lg:p-8">
                        ...
                        >
                            ...
                            {{-- Chủ đề --}}
                            <div>
                                <label for="subject" class="mb-2 block text-sm font-semibold text-slate-700">
                                    Chủ đề cần hỗ trợ <span class="text-red-500">*</span>
                                </label>
                                <select
                                    id="subject"
                                    name="subject"
                                ...
                                >
                                    ...
                                    <option value="Hỗ trợ đặt phòng" @selected(old('subject') === 'Hỗ trợ đặt phòng')>
                                        Hỗ trợ đặt phòng
                                    </option>
                                    <option value="Hỗ trợ tài khoản" @selected(old('subject') === 'Hỗ trợ tài khoản')>
                                        Hỗ trợ tài khoản
                                    </option>
                                    <option value="Thanh toán và hoàn tiền" @selected(old('subject') === 'Thanh toán và hoàn tiền')>
                                        Thanh toán và hoàn tiền
                                    </option>
                                    <option value="Khiếu nại dịch vụ" @selected(old('subject') === 'Khiếu nại dịch vụ')>
                                        Khiếu nại dịch vụ
                                    </option>
                                    <option value="Góp ý cho HomeStayGo" @selected(old('subject') === 'Góp ý cho HomeStayGo')>
                                        Góp ý cho HomeStayGo
                                    </option>
                                    <option value="Vấn đề khác" @selected(old('subject') === 'Vấn đề khác')>
                                        Vấn đề khác
                                    </option>
                                </select>
                                @error('subject')
                            ...
                            <div>
                                <div class="mb-2 flex items-center justify-between gap-3">
                                    ...
                                    <span id="message-count" class="text-xs font-medium text-slate-400">
                                        0/5000
                                    </span>
                                </div>
                                <textarea
