...
@section('content')
    ...
    <x-frontend-breadcrumb :items="[['label' => 'Trang chủ', 'url' => route('home')], ['label' => 'Danh sách Homestay']]" />
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button" @click="mobileFilterOpen = true"
                                class="cursor-pointer inline-flex items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-50 lg:hidden">
                                ...
                                @if ($activeFilterCount > 0)
                                    <span
                                        class="flex h-5 min-w-5 items-center justify-center rounded-full bg-blue-600 px-1.5 text-[11px] font-bold text-white">
                                        {{ $activeFilterCount }}
                                    </span>
                                @endif
                            </button>
                            ...
                            <form method="GET" action="{{ route('homestays.index') }}"
                                ...
                                <select id="sort" name="sort" onchange="this.form.submit()"
                                    class="cursor-pointer rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-semibold text-slate-700 outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                    ...
                    @else
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            @foreach ($homestays as $homestay)
                                ...
                                <article
                                    class="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:border-blue-200 hover:shadow-md">
                                    {{-- Ảnh --}}
                                    <div class="relative aspect-4/3 overflow-hidden bg-slate-100">
                                        ...
                                        <span
                                            class="absolute left-2.5 top-2.5 rounded-full px-2.5 py-1 text-[11px] font-semibold border border-slate-200 text-slate-900 shadow-xl backdrop-blur">
