                            ...
                            <div class="flex min-w-max gap-6 px-6 py-2 items-center justify-between lg:min-w-0" role="tablist" aria-label="Nội dung Homestay">
                                ...
                                @foreach ($tabItems as $tab)
                                    <button type="button" role="tab" data-tab-target="{{ $tab['id'] }}"
                                        ...
                                        class="homestay-tab cursor-pointer border-b-5 inline-flex min-h-11 shrink-0 items-center justify-center py-2.5 pt-[14.8px] text-sm font-semibold transition lg:flex-1
                                            {{ $loop->first
                                ...
                                <div class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
                                    <div class="p-6 sm:p-8">
                                        ...
                                        <div class="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                                            ...
                                            <button type="button"
                                                class="inline-flex cursor-pointer shrink-0 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition hover:border-red-300 hover:bg-red-50 hover:text-red-600 focus:bg-red-500 focus:text-white focus:outline-none focus:ring-4 focus:ring-red-100">
