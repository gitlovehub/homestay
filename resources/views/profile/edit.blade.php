...
<head>
    ...
    <title>Hồ sơ cá nhân | HomeStayGo</title>
        ...
        <section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <p class="mt-3 max-w-2xl text-slate-500">
                    Quản lý thông tin tài khoản, lịch sử đặt phòng và bảo mật đăng nhập.
                </p>
                        ...
                        <ul class="space-y-1">
                            ...
                            <li>
                                <a href="#account-information"
                                    ...
                                    <span
                                        class="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-100 text-base transition group-hover:bg-blue-200">
                                        👤
                                    </span>
                                    Thông tin cá nhân
                                </a>
                            ...
                            <li>
                                <a href="{{ route('bookings.history') }}"
                                    class="group flex items-center gap-3 rounded-xl p-3 text-sm font-semibold text-slate-700 transition hover:bg-blue-50 hover:text-blue-600">
                                    <span
                                        class="flex h-9 w-9 items-center justify-center rounded-lg bg-amber-100 text-base transition group-hover:bg-amber-200">
                                        📅
                                    </span>
                                    Lịch sử đặt phòng
                                </a>
                            ...
                            <li>
                                <a href="#security"
                                    class="group flex items-center gap-3 rounded-xl p-3 text-sm font-semibold text-slate-700 transition hover:bg-blue-50 hover:text-blue-600">
                                    <span
                                        class="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-100 text-base transition group-hover:bg-emerald-200">
                                        🔐
                                    </span>
                                    Đổi mật khẩu
                                </a>
                            ...
                            @if ($user->isAdmin())
                                <li>
                                    <a href="{{ route('admin.dashboard') }}"
                                        class="group flex items-center gap-3 rounded-xl p-3 text-sm font-semibold text-slate-700 transition hover:bg-blue-50 hover:text-blue-600">
                                        <span
                                            class="flex h-9 w-9 items-center justify-center rounded-lg bg-indigo-100 text-base transition group-hover:bg-indigo-200">
                                            ⚙️
                                        </span>
                                        Trang quản trị
                                    </a>
                            ...
                            <li>
                                <a href="{{ route('home') }}"
                                    class="group flex items-center gap-3 rounded-xl p-3 text-sm font-semibold text-slate-700 transition hover:bg-blue-50 hover:text-blue-600">
                                    <span
                                        class="flex h-9 w-9 items-center justify-center rounded-lg bg-slate-100 text-base transition group-hover:bg-slate-200">
                                        🏠
                                    </span>
                                    Quay về trang chủ
                                </a>
                            ...
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                        ...
                                        <span
                                            class="flex h-9 w-9 items-center justify-center rounded-lg bg-red-50 text-red-500 transition group-hover:bg-red-100">
                ...
                <div class="min-w-0 space-y-8">
                    ...
                    <section class="grid grid-cols-2 gap-4 xl:grid-cols-4">
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            <p class="mt-4 text-2xl font-bold text-slate-900">
                                {{ $user->completed_bookings_count ?? 0 }}
                            </p>
                        ...
                        <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                            ...
                            <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-orange-100 text-xl">
                                ⭐
                            </div>
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <div class="flex flex-wrap items-center gap-2">
                                            ...
                                            <span
                                                ...
                                                {{ $bookingStatusClasses[$latestBooking->status] ?? 'bg-slate-100 text-slate-700' }}">
                                        ...
                                        <div class="mt-4 flex flex-wrap gap-x-5 gap-y-2 text-sm text-slate-500">
                                            ...
                                            <span>
                                                ...
                                                <strong class="text-slate-700">
                                                    {{ $latestBooking->check_in?->format('d/m/Y') }}
                                                </strong>
                                            </span>
                                            ...
                                            <span>
                                                Trả phòng:
                                                <strong class="text-slate-700">
                                                    {{ $latestBooking->check_out?->format('d/m/Y') }}
                                                </strong>
                                            </span>
                        ...
                        @else
                            <div
                                ...
                                <p class="mt-2 text-sm text-slate-500">
                                    Hãy khám phá những Homestay phù hợp với bạn.
                                </p>
                    ...
                    >
                        ...
                        <div class="border-b border-slate-200 px-6 py-6 sm:px-8">
                            ...
                            <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
                                Cập nhật ảnh đại diện và thông tin sử dụng khi đặt phòng.
                            </p>
                    ...
                    <section id="security"
                        ...
                        @if (session('status') === 'password-updated')
                            <div
                                class="mt-6 rounded-2xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm font-semibold text-emerald-700">
                            ...
                            <div class="grid gap-5 sm:grid-cols-2">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="password" id="update_password_current_password"
                                        ...
                                        class="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition focus:border-blue-500 focus:ring-4 focus:ring-blue-100">
                    ...
                    <section class="rounded-3xl border border-red-200 bg-white p-6 shadow-sm sm:p-8"
                        x-data="{
                            deleteOpen: {{ $errors->userDeletion->isNotEmpty() ? 'true' : 'false' }}
                        ...
                        <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div>
                                ...
                                <p class="mt-2 max-w-xl text-sm leading-6 text-slate-500">
                                    Tài khoản và dữ liệu liên quan sẽ bị xóa vĩnh viễn. Hành động này không thể hoàn
                                    tác.
                                </p>
                            ...
                            <div x-show="deleteOpen" x-transition
                                ...
                                <form method="POST" action="{{ route('profile.destroy') }}" class="mt-6">
                                    ...
                                    <input type="password" id="delete_account_password" name="password"
                                        ...
                                        class="mt-2 w-full rounded-xl border px-4 py-3 text-sm outline-none transition
